...
define('ADMIN_PATH', ROOT_PATH . '/track/admin');
define('CONFIG_FILE', ADMIN_PATH . '/db.php');
...
function step1() {
    ...
    $requirements = [
        ...
        'Write Permissions (admin directory)' => is_writable(ADMIN_PATH),
...
function step4() {
    ...
    echo '<ol>';
    echo '<li>Delete the <code>setup.php</code> file for security reasons</li>';
    ...
    echo '<strong>Security Notice:</strong> Please delete the setup.php file immediately to prevent unauthorized access.';
    echo '</div>';
